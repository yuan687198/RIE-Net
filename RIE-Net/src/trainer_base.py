...
class TrainerBase(object):
    ...
    def create_config(self):
        ...
        config = config_class.from_pretrained('/data/yuanmq/VLT5/t5-base')    #,self.args.backbone
    ...
    def create_model(self, model_class, config=None, **kwargs):
        ...
        model = model_class.from_pretrained('/data/yuanmq/VLT5/t5-base',
            #model_name,
            config=config,
            **kwargs
        )
    ...
    def create_tokenizer(self, **kwargs):
        ...
        tokenizer = tokenizer_class.from_pretrained('/data/yuanmq/VLT5/t5-base',
            #tokenizer_name,
